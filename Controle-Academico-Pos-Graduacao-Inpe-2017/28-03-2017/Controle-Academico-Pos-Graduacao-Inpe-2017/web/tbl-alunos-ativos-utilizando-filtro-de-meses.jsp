    ...
    <script type="text/javascript">
        function criarArquivoCSV(){
            ...
            <%
                ...
                TreeMap<String, TreeMap<String, String>> mapa_resultado = Main.buscarAlunosAtivosAPartirDeUmaDeterminadaQuantidadeDeMeses(request.getParameter("nivelAluno"), request.getParameter("quantidadeMeses"), academxp_2.getTable("CURSO_AL"), academxp_2.getTable("GDRPESS")); 
                ...
                <table class="table table-striped table-bordered table-hover" id="tabela-resultado-formulario-de-busca-de-alunos-ativos-utilizando-filtro-de-meses">
                    ...
                    <tbody>
                        <% 
                            ...
                            TreeMap<String, TreeMap<String, String>> mapaResultado = Main.buscarAlunosAtivosAPartirDeUmaDeterminadaQuantidadeDeMeses(request.getParameter("nivelAluno"), request.getParameter("quantidadeMeses"), academxp.getTable("CURSO_AL"), academxp.getTable("GDRPESS"));

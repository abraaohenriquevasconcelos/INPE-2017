...
public class Main {
    ...
    */
    ...
    public static String montaGráficoComAEstimativaDeTempoParaCadaAlunoAssociadoAoDocente(String codigoDocente){
        StringBuilder sb = new StringBuilder().append("{label:\"\",");
        TreeMap<String, TreeMap<String, String>> alunosAssociadosAoDocente = obterAlunosAtivosDoCAPAPartirDoCodigoDoDocente(codigoDocente);
    ...
    */
    ...
    public static void main(String[] args){
        ...
        System.out.println(montaGráficoComAEstimativaDeTempoParaCadaAlunoAssociadoAoDocente("45879"));
    }
}
